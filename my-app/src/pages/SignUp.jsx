...
export default function SignUp() {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <h1 className="text-3xl font-heading font-bold text-nu-black dark:text-dark-text mb-2">Create your account</h1>
      <p className="text-nu-gray-500 dark:text-dark-muted mb-8">Use your Northeastern email to get started</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          />
          <p className="text-xs text-nu-gray-400 dark:text-dark-muted mt-1">
        ...
        <div>
          <label htmlFor="confirm-password" className="block text-sm font-medium text-nu-gray-700 dark:text-dark-text mb-1">
            Confirm Password
          </label>
          <input
            id="confirm-password"
